...
const TOKEN_NAME = 'KOALA';
const TOKEN_SYMBOL = 'KOALA';
const TOKEN_DESCRIPTION = 'A token for koalas';
const TOKEN_IMAGE_NAME = 'koala.png'; // Replace unicorn.png with your image name
